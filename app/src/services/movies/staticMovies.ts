...
export const staticMovies: Media[] = [
  {
    id: 'tt0111161',
    mediaType: 'movie',
        ...
        services: [
          {
            ...
            logo: 'https://upload.wikimedia.org/wikipedia/commons/7/75/Paramount%2B_Logo.svg',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    overview:
      'Marty McFly, a 17-year-old high school student, is accidentally sent thirty years into the past in a plutonium-powered time-traveling DeLorean invented by his close friend, the eccentric scientist Doc Brown.',
    ...
    streamingOptions: [
      {
        ...
        services: [
          {
            serviceName: 'Peacock',
            logo: 'https://upload.wikimedia.org/wikipedia/commons/3/32/Peacock_Logo.svg',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    title: 'Goodfellas',
    overview:
      'The story of Henry Hill and his life in the mob, covering his relationship with his wife Karen Hill and his mob partners over three decades.',
  ...
  },
  {
    ...
    overview:
      'Following the Normandy Landings, Captain John H. Miller and his men must go behind enemy lines to find and bring home the titular Private Ryan.',
    genres: ['Drama', 'War'],
